...
// Carica i parametri da file (default: "run_bpop.txt")
void load_config(const string& filename = "run_bpop.txt");

// ===== Variabili globali (rimpiazzano i vecchi #define) =====

// SWITCH / MISC
extern string CHUNKS;
// DATAFILES
extern string PREDIR, SINGPTH, PATH, SEVN, MERGER_EFF_CORR;
...
// (DEPRECATED, ma mantenuti per compatibilità)
