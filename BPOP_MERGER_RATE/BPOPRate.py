...
fdyn  = [0.9,0.9,0.9,0.9]
fgc   = [0.1,0.1,0.1,0.1]
fyc   = [0.8,0.8,0.8,0.8]
fnc   = [0.1,0.1,0.1,0.1]
spinI = ["maxwellian02","maxwellian02","maxwellian02","maxwellian02"]
spinD = ["maxwellian02","maxwellian02","maxwellian02","maxwellian02"]
clurad= ["AS20","AS20","AS20","AS20"]
bhseed= ["bifrost","bifrost","density","no"]
umg   = ["dicarlo","dicarlo","dicarlo","dicarlo"]
highg = ["no","no","no","no"]
mix   = ["0.5G","0.5G","0.5G","0.5G"]
vms   = ["","","VMSrho0.2",""]
...
home = "../../../"+simname+"/"
codename = [simname+"_Continuous/HIGN/"]
...
K = np.loadtxt(Gn, dtype={'names':('mpri', 'msec', 'mclu', 'rclu', 'tfor', 'tmer', 'clu', 'stat', 'id'), 'formats':(float, float, float,float, float, float,'U8','U8',float)}, usecols = [0,1,19,20,7,15,24,23,30], unpack=True)
...
for kt in range(len(clt)):    
    f = open("Merger_rates_"+simname+a+"_"+clt[kt]+"_massive_"+massive+".txt", "w")
    stri = ""
